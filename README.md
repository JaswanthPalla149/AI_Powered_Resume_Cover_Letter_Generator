...
4. Run the Flask API server to host the fine-tuned model - folder not available on github now.
5. Launch the desktop app with python Main.py, enter profile and job info.
